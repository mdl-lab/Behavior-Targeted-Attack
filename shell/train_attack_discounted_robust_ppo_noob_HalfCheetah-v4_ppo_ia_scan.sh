...
sh -c 'cd /gs/bs/tga-mdl/yamabe-mdl/implement/SAIA/src && python run_agents.py ../configs/agent_configs_attack_discounted_robust_ppo_noob_HalfCheetah-v4_ppo_ia_scan --adv-policy-only --deterministic --out-dir-prefix=../configs/agents_attack_discounted_robust_ppo_noob_HalfCheetah-v4_ppo_ia_scan > logs/attack_discounted_robust_ppo_noob_HalfCheetah-v4_ppo_ia_scan.log'