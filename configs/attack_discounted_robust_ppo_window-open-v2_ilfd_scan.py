...
PARAMS = {
    "game": ["window-open-v2"],
    "mode": ["adv_ilfd"],
    "out_dir": ["experiments/attack_discounted_robust_ppo_ilfd/window-open-v2/agents"],
    "norm_rewards": ["none"],
    ...
    "load_model": ["models/discounted_robust_ppo_window-close-v2.model"],  # models for attack
    "value_clipping": [True],
    "t": [1000],
    "gradient_steps": [250],
    ...
    "expert_buffer_path": ["demo/window-open-v2_demo.pkl"],
}
