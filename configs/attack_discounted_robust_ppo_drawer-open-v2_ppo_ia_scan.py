...
PARAMS = {
    "game": ["drawer-open-v2"],
    "mode": ["adv_ppo_ia"],
    "out_dir": ["experiments/attack_discounted_robust_ppo_ppo_ia/drawer-open-v2/agents"],
    ...
    "load_model": ["models/discounted_robust_ppo_drawer-close-v2.model"],  # models for attack
    "value_clipping": [True],
}
